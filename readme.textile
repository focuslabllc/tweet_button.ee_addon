...
<pre><code>{exp:tweet_button}</pre></code>
...
<script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></pre></code>
...
<pre><code>{exp:tweet_button:js}</pre></code>
